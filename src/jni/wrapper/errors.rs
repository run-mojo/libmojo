...
pub fn jni_error_code_to_result(code: crate::jni::sys::jint) -> Result<()> {
    match code {
        crate::jni::sys::JNI_OK => Ok(()),
        crate::jni::sys::JNI_EDETACHED => Err(Error::from(ErrorKind::ThreadDetached)),
