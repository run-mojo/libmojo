...
use crate::jni::wrapper::strings::JavaStr;

use crate::jni::wrapper::objects::AutoLocal;
use crate::jni::wrapper::objects::GlobalRef;
use crate::jni::wrapper::objects::JByteBuffer;
use crate::jni::wrapper::objects::JClass;
use crate::jni::wrapper::objects::JFieldID;
use crate::jni::wrapper::objects::JList;
use crate::jni::wrapper::objects::JMap;
use crate::jni::wrapper::objects::JMethodID;
use crate::jni::wrapper::objects::JObject;
use crate::jni::wrapper::objects::JStaticFieldID;
use crate::jni::wrapper::objects::JStaticMethodID;
use crate::jni::wrapper::objects::JString;
use crate::jni::wrapper::objects::JThrowable;
use crate::jni::wrapper::objects::JValue;

use crate::jni::wrapper::descriptors::Desc;

use crate::jni::wrapper::signature::JavaType;
use crate::jni::wrapper::signature::Primitive;
use crate::jni::wrapper::signature::TypeSignature;

use crate::jni::wrapper::JNIVersion;
use crate::jni::wrapper::JavaVM;
...
impl<'a> JNIEnv<'a> {
        ...
        T: Send + 'static,
    {
        ...
        self.set_field_unsafe(obj, field_id, (ptr as crate::jni::sys::jlong).into())
    }
